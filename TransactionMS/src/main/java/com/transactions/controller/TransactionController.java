...
public class TransactionController {
	 ...
	 */
	@GetMapping(value = "/getCustomerTransactions/{customerId}", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<TransactionRTO>> getCustomerTransactions(@PathVariable("customerId")Integer customerId){	
		ResponseEntity<List<TransactionRTO>> response = transactionService.getCustomerTransactions(customerId);		
		return response;
	}
